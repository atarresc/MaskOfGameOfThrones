...
import net.infobosccoma.JocDeTrons.Screens.IniciScreen;
...
public class JocDeTrons extends Game {
	...
	public void create() {
        ...
        if(Gdx.app.getType() == Application.ApplicationType.Android) {
            skin.getFont("defaultFont").setScale(Gdx.graphics.getDensity(), Gdx.graphics.getDensity());
            skin.getFont("scoreFont").setScale(Gdx.graphics.getDensity(), Gdx.graphics.getDensity());
        }
        // començar el joc amb la SplashScreen
        setScreen(new IniciScreen(this));
   	}
