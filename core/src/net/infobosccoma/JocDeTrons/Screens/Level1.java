...
import net.infobosccoma.JocDeTrons.GestorContactes;
...
public class Level1 extends AbstractScreen {
    ...
    public Level1(net.infobosccoma.JocDeTrons.JocDeTrons joc, int lives) {
        super(joc);
...
//		lives = new Image(lives_texture);
        ...
        mask_object = new Mask_object(world,24.40f, 8.0f);
       // mask_object = new Mask_object(world,2f, 3.0f);
