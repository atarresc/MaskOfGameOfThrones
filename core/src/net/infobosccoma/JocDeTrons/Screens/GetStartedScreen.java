...
public class GetStartedScreen extends AbstractScreen {
    ...
    public GetStartedScreen(net.infobosccoma.JocDeTrons.JocDeTrons joc) {
        super(joc);
    }
    //</editor-fold>
...
//        musica.play();
        ...
        splashTexture = new Texture(
                Gdx.files.internal("imatges/pantallaIntro.png"));
        ...
        splashImage.addAction(Actions.sequence(Actions.fadeIn(1f),
                Actions.delay(8f), Actions.fadeOut(1f), new Action() {
                    @Override
