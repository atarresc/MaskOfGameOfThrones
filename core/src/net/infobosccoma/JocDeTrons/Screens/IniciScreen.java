 ...
 *
 */
public class IniciScreen extends AbstractScreen {
    ...
    public IniciScreen(net.infobosccoma.JocDeTrons.JocDeTrons joc) {
        super(joc);
    }
    //</editor-fold>
...
//        musica.play();
        ...
        splashTexture = new Texture(
                Gdx.files.internal("imatges/pantallaInici.png"));
...
//        musica.stop();
        ...
        joc.setScreen(new SecondScreen(joc));
    }
